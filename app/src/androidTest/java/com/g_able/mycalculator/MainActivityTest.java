...
public class MainActivityTest {
    ...
    @Test
    public void sub() {
        onView(withId(R.id.operand_one_edit_text)).perform(typeText("3"));
    ...
    public void mul() {
        ...
        onView(withId(R.id.operation_result_text_view)).check(matches(withText("6.0")));
    }
    ...
    public void divZero() {
        onView(withId(R.id.operand_one_edit_text)).perform(typeText("3"));
        onView(withId(R.id.operand_two_edit_text)).perform(typeText("0"));
        onView(withId(R.id.operation_div_button)).perform(click());
        onView(withId(R.id.operation_result_text_view)).check(matches(withText("Infinity")));
    }
}
